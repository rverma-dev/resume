---
layout: resume
title: Rohit Verma - Amazon Web Services (AWS) - Principal, Senior Principal and Distinguished Engineer, AWS Agentic AI Resume
permalink: /applications/resumes/app-20260707-amazon-web-services-aws-principal-senior-principal-and-disti-cc4942ae/submitted/
---
# Rohit Verma
...
Principal-level AI infrastructure and distributed systems engineer for AWS Agentic AI platforms, emphasizing governed agent systems, multi-tenant observability, cloud infrastructure, and large-scale service architecture.
